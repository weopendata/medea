    ...
    <div class="container" v-show="showForm == true">
        ...
        <form id="new_find">
            <div class="form-group row has-error">
                ...
                <div class="col-sm-6">
                   <button class="btn btn-default" @click.prevent="showUpload">Upload foto</button>
                   <span class="help-block">De huidige foto voldoet niet, upload een nieuwe om de vondst volledig correct te laten registreren.</span>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <textarea v-model="description" type="text" class="form-control" id="description" rows="10" disabled>"Een gouden munt uit de vroege romeinse tijd.</textarea>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-2">
                    <input type="date" value="01/02/2016" v-model="findDate" class="form-control" disabled />
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-sm-offset-2 col-sm-2">
                    <input value="50.806905897875" v-model="location.lat" type="text" class="form-control" disabled>
                </div>
                <div class="col-sm-2">
                    <input value="3.3014484298127" v-model="location.lon" type="text" class="form-control" disabled>
                </div>
            </div>
            ...
            <label for="material" class="col-sm-2 control-label">Materiaal*</label>
                <div class="col-sm-6">
                    <div class="input-group error">
                        <select v-model="material" class="form-control" disabled>
            ...
            <label for="productionTechnique" class="col-sm-2 control-label">Techniek</label>
                <div class="col-sm-6">
                    <div class="input-group">
                        <select v-model="productionTechnique" class="form-control" disabled>
            ...
            <label class="col-sm-2 control-label">Oppervlaktebehandeling</label>
                <div class="col-sm-6">
                    <div class="input-group">
                        <select v-model="surfaceTreatment" class="form-control" disabled>
            ...
            <div class="row top-buffer">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <select v-model="category" class="form-control" id="category" disabled>
                            <option></option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <input value="50" v-model="start_year" class="form-control" id="category" type="text" disabled>
                    </div>

                    <p class="text-center col-md-1">-</p>

                    <div class="col-sm-2">
                        <input value="150" v-model="end_year" class="form-control" id="category" type="text" disabled>
                    </div>

                    <div class="col-sm-1">
                        <select v-model="era" class="form-control" disabled>
                            <option>v. Chr.</option>
...
<template id="dimension-template">
    <div>
        <div class="col-sm-4">
            <div class="input-group">
                <select v-model="dimension.unit" class="form-control" disabled>
        ...
        <div class="col-sm-2">
            <div class="input-group">
                <input v-model="dimension.quantity" type="text" class="form-control" id="dimensions" placeholder="" disabled>
            </div>
        </div>

        <div class="col-sm-3">
            <div class="input-group">
                <select v-model="dimension.symbol" class="form-control" disabled>
...
<template id="reference-template">
    <div class="col-md-offset-2 col-md-6">
        <input v-model="reference" type="text" class="form-control" id="reference" placeholder="" disabled>
    </div>
</template>
