...
<div id="app" class="container">
    ...
    <div id="experts" v-if="viewRole == 'Detectorist/Registrator'">
      <div class="row row-stretch tall-col">
        <div class="col-md-3">
          <div class="row">
            <form id="search" @submit.prevent="">
    ...
    <div id="experts" v-if="viewRole == 'Vondstexpert/Onderzoeker'">
      <div class="row row-stretch tall-col">
        <div class="col-md-12">
          <div class="row">
            <form id="search" @submit.prevent="">
    ...
    <div id="experts" v-if="viewRole == 'Data manager/Agentschap'">
      <div class="row row-stretch tall-col">
        <div class="col-md-3">
          <div class="row">
            <form id="search" @submit.prevent="">
...
var vm = new Vue({
  ...
  data: {
    viewRoles : [
        "Publiek",
        "Detectorist/Registrator",
        "Vondstexpert/Onderzoeker",
        "Data manager/Agentschap"
    ],
    ...
    allData : [
...

            {
                ...
                category : "accessoire",
                description : "Een armband die toebehoorde aan een vrouw van adel.",
                dimension : "20x5 cm",
                date : "50 n. Chr. - 100 n. Chr.",
                location : [50.806905897875, 3.2427863148763]
            }
    ],
    ...
    allDataList : {
        'inReview' : [
...

            {
                ...
                dimension : "20x5 cm",
                date : "50 n. Chr. - 100 n. Chr.",
                location : [50.816905897875, 3.2427863148763]
            }
        ],
        ...
        'published' : [
            {
                ...
                dimension : "200x5x8 cm",
                date : "200 v. Chr. - 150 n. Chr.",
                location : [50.846905897875, 3.2474169937074]
            },

            {
                title : "Schild uit de Griekse periode",
                category : "schild",
                description : "Een typisch grieks schild uit de oudheid.",
                dimension : "200x5x8 cm",
                date : "200 v. Chr. - 150 n. Chr.",
                location : [50.816905897875, 3.2474169937074]
            }
        ],
        ...
        'embargo' : [
...

            {
                title : "Schatkist",
                category : "munt",
                description : "Schatkist met gouden en zilveren sieraden.",
                dimension : "40x40x100 cm",
                date : "20 n. Chr. - 100 n. Chr.",
                location : [50.828905897875, 3.3014484298127]
            }
        ],
        ...
        'deleted' : [
            ...
            {
                title : "De ronde tafel",
                category : "Meubel",
                description : "De mytische ronde tafel van Koning Arthur.",
                dimension : "1000x10000 cm",
                date : "1300 n. Chr. - 1450 n. Chr.",
                location : [50.855905897875, 3.2227863148763]
            }
        ]
    }
  },
  ...
  watch : {
    detectoristEntities : function (val) {
        ...
        if (this.viewRole == 'Data manager/Agentschap') {
            this.allData = this.allDataList[val];
            data = this.allData;
        } else {
            this.detectoristData = this.detectoristDataList[val];
            data = this.detectoristData;
        }
        ...
        for (i = 0; i < data.length; ++i) {
            var item = data[i];
            var marker = L.marker(data[i].location, {icon: window.redMarker,});
            marker.bindPopup("<b>" + item.title + "</b><br><b>category: " + item.category + "</b><br>" + item.description).openPopup();
            layergroup.push(marker);
        }
    ...
    viewRole : function (val) {
        if (val == 'Detectorist/Registrator') {
            this.initMap(this.detectoristData);
        } else if (val == 'Publiek') {
            this.initMap(this.origData);
        } else if (val == 'Data manager/Agentschap') {
