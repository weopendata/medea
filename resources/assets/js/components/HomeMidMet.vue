  ...
  <div>
    <div class="midmet-hero">
      <form method="GET" action="/finds" class="ui container">
        ...
        <p>
          Doorzoek de databank via de <a href="/finds">Vondstlijst</a>, de <a
            href="/typology-browser">Typologie-browser</a> of het zoekvenster hieronder.
        </p>
        <p>
